      ...
      >
        ...
        <div className="bg-card rounded-[2.5rem] p-10 sm:p-12 border-[1.5px] border-border shadow-2xl shadow-black/5 relative overflow-hidden">
          ...
          <div className="text-center mb-10">
             <h2 className="text-2xl font-black text-black tracking-tight">{t("Welcome back", "Welcome back")}</h2>
             <p className="text-sm font-bold text-slate-400 mt-1 uppercase tracking-widest opacity-60">{t("Sign in to your vault", "Sign in to your vault")}</p>
          </div>
            ...
            >
              {googleLoading ? (
                ...
                <>
                  ...
                  <span className="text-black">{t("Sign in with Google", "Sign in with Google")}</span>
                </>
              )}
            </Button>
            ...
            <form onSubmit={handleEmailLogin} className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between ml-1">
                  <Label htmlFor="password" className="text-[10px] font-black uppercase tracking-widest text-slate-400">{t("Password", "Password")}</Label>
                  <Link href="/forgot-password" title="Forgot Password" className="text-[10px] font-bold text-primary/60 hover:text-primary transition-colors">{t("Forgot?", "Forgot?")}</Link>
                </div>
                <div className="relative group">
